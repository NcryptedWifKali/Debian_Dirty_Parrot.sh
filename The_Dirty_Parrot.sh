#!/bin/bash
echo "Hard Work gifts the student Perserverence....It Dont Hurt to Have a lil Stamina fuled by cofee either"
show_menu(){
    NORMAL=$("\033[m")
    MENU=$("\033[36m") #Blue
    ...
    ENTER_LINE=$("\033[33m")
    echo -e "${MENU}*********************************************${NORMAL}"
    echo -e "Welcome to Dirty-Birdy a.k.a Parrot On-Debian Installer Script"
    echo -e "Revamped By:subconscious_navigator a.k.a NcryptedWifKali"    
...
echo "Get Some Sleep Tweaker!!!,This script needs to be run as root!"
